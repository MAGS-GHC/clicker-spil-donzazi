...
// - Now we need to deduct the cookies that the user is using to buy a Baker with. To do so, we say that everytime the user buys a Baker, the cost i 20. We put our "cookies"-variable in the "if-statement". So that means that Everytime our "cookiesPerClick" goes up by "1", ww got to take away the cost, which is 20 cookies.
